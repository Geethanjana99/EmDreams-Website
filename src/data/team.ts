...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    skills: ['Agile', 'Stakeholder Management', 'Risk Assessment', 'Scrum', 'JIRA'],
    social: {
      linkedin: '',
      twitter: '',
    },
  },
  {
    ...
    skills: ['React Native', 'Swift', 'Kotlin', 'Mobile UI', 'App Store Optimization'],
    social: {
      github: '',
      linkedin: '',
    },
  ...
  },
  {
    ...
    skills: ['Test Automation', 'Selenium', 'Jest', 'Performance Testing', 'QA Strategy'],
    social: {
      github: '',
      linkedin: '',
    },
